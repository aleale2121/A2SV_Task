using BLOG.Core.ContributorAggregate;
using Ardalis.SharedKernel;
using FastEndpoints;
using BLOG.Web.Endpoints.ContributorEndpoints;
using BLOG.UseCases.Contributors.Create;
using BLOG.UseCases.Contributors.Update;
using MediatR;
using Ardalis.Result;

namespace BLOG.Web.ContributorEndpoints;
